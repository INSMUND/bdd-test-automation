  ...
  "rows": [
    ...
    },
    {
      "cells": [
        ...
        "79668899",
        "m.a.i.lfortests16082019@gmail.com",
        "testpesoto2019",
        "testpesoto2019"
      ]
    },
    {
      "cells": [
        ...
        "str.Paris 10",
        "79668809",
        "ma.i.lfortests16082019@gmail.com",
        "testpesoto2019",
        "testpesoto2019"
      ]
    }
...
formatter.step({
  "name": "fills  phone as 79668899,email as  m.a.i.lfortests16082019@gmail.com",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "User fills  name in romanian Iulia, surname in romanian as Silonosova",
  "keyword": "When "
});
formatter.match({
  "location": "RegistrationFormSubmitionStepDefinition.user_fills_form_UserNameRom_UserSurameRom(String,String)"
...
formatter.step({
  "name": "fills  name in english Iulia, surname in english as  Shilonosova",
  "keyword": "And "
});
formatter.match({
  "location": "RegistrationFormSubmitionStepDefinition.user_fills_form_UserNameEng_UserSurameEng(String,String)"
...
formatter.step({
  "name": "fills  gender as 1,city as Chisinau, address as str.Paris 10",
  "keyword": "And "
});
formatter.match({
  "location": "RegistrationFormSubmitionStepDefinition.user_fills_form_gender_city_address(int,String,String)"
...
formatter.step({
  "name": "fills  phone as 79668809,email as  ma.i.lfortests16082019@gmail.com",
  "keyword": "And "
});
formatter.match({
  "location": "RegistrationFormSubmitionStepDefinition.user_fills_form_phone_email(String,String)"
...
formatter.step({
  "name": "user finds confirmation email in list of inbox email noticed in Registration form m.a.i.lfortests16082019@gmail.com password mailForTests2019 server imap.gmail.com port 993",
  "keyword": "Given "
});
formatter.match({
...
formatter.step({
  "name": "user finds confirmation email in list of inbox email noticed in Registration form ma.i.lfortests16082019@gmail.com password mailForTests2019 server imap.gmail.com port 993",
  "keyword": "Given "
});
formatter.match({
  "location": "ActivationAccountFromConfirmationEmailStepDefinition.get_list_inbox_email(String,String,String,String)"
